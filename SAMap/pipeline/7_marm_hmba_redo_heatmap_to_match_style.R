...
dir_samap_res <- file.path(dir_samap, "results_marm_hmba")
...
idx_keep <- which(rownames(samap_res_fix) != "marmoset.LAMP5/LHX6")
...
pdf(
    file.path(dir_samap_res, "mapping_table_clust_anno_splitsubc55_complexheatmap_dropLamp5.pdf"),
    width = 9, height = 7
)
p
dev.off()
...
pdf(
    file.path(dir_samap_res, "mapping_table_clust_anno_splitsubc55_complexheatmap_dropLamp5_dropOtherTh.pdf"),
    width = 9, height = 7
)
p
dev.off()
...
pdf(
    file.path(dir_samap_res, "mapping_table_clust_anno_splitsubc55_complexheatmap_dropLamp5_dropOtherTh_reorder_nodend.pdf"),
    width = 9, height = 7
)
p
dev.off()
